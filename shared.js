const I18N = {
  en: {
    ...
    inspections: {
      ...
      mileage: "Mileage (KM)",
      treadLabel: "Tire Tread Depth (32nds)",
    ...
    diagnostic: {
      ...
      description: "Testing tools only — simulate a different date and mileage to see how due dates, monthly averages, and seasonal reminders actually respond, without waiting real days for it.",
      simDateLabel: "Simulated Date",
      simMileageLabel: "Simulated Mileage (KM)",
      applyDateBtn: "Apply",
      clearDateBtn: "Reset to Real Today",
      simHint: "Applying sets this vehicle's current date and mileage directly, and logs a mileage data point — exactly as if you'd entered them normally on the Status tab. Due dates, the dashboard, and monthly averages will all update to match.",
      ...
      dateAppliedToast: (date) => `Simulated date and mileage applied — now set to ${date}.`,
      dateClearedToast: "Reset to the real current date.",
    ...
    about: {
      ...
      dataBody: [
        ...
        "GearLog also keeps a running log of the mileage you enter over time, tied to the dates you entered it. This is what powers the auto-calculated monthly average and year-to-date mileage shown on your dashboard — figures that used to require guessing a manual average now come directly from your own real entries, and get more accurate the more you use the app.",
  ...
  fr: {
    ...
    inspections: {
      ...
      treadLabel: "Profondeur de bande de roulement (32es)",
    ...
    diagnostic: {
      ...
      description: "Outils de test seulement — simulez une date et un kilométrage différents pour voir comment les échéances, les moyennes mensuelles et les rappels saisonniers réagissent réellement, sans attendre plusieurs jours réels.",
      simDateLabel: "Date simulée",
      simMileageLabel: "Kilométrage simulé (KM)",
      applyDateBtn: "Appliquer",
      clearDateBtn: "Réinitialiser à la vraie date",
      simHint: "Appliquer règle directement la date actuelle et le kilométrage de ce véhicule, et enregistre un point de données de kilométrage — exactement comme si vous les aviez entrés normalement dans l'onglet État. Les échéances, le tableau de bord et les moyennes mensuelles seront tous mis à jour en conséquence.",
      ...
      dateAppliedToast: (date) => `Date et kilométrage simulés appliqués — maintenant réglés à ${date}.`,
      dateClearedToast: "Réinitialisé à la vraie date actuelle.",
    ...
    about: {
      ...
      dataBody: [
        ...
        "GearLog conserve aussi un historique du kilométrage que vous entrez au fil du temps, associé aux dates où vous l'avez entré. C'est ce qui alimente la moyenne mensuelle calculée automatiquement et le kilométrage parcouru cette année affichés sur votre tableau de bord — des chiffres qui exigeaient autrefois de deviner une moyenne manuelle proviennent maintenant directement de vos propres entrées réelles, et deviennent plus précis à mesure que vous utilisez l'application.",
