  ...
  en: {
    ...
    finder: {
      ...
      results: {
        ...
        "perfas": { title: "Performance All-Season", reason: "You want serious grip but also need it to work through some winter — this keeps most of that performance without the seasonal swap." },
  ...
  fr: {
    ...
    finder: {
      ...
      results: {
        ...
        "perfas": { title: "Performance Quatre-Saisons", reason: "Vous voulez une adhérence sérieuse tout en ayant besoin qu'elle fonctionne un peu en hiver — ceci conserve la majeure partie de cette performance sans le changement saisonnier." },
